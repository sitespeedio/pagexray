...
// Common two-label public suffixes. Not exhaustive — a full fix would
// consult the Public Suffix List, but this catches the cases that
// actually break the auto-generated firstParty regex in the wild.
  ...
  getMainDomain: hostname => {
    ...
    if (hostname != null) {
      ...
      if (parts != null && parts.length > 1) {
        ...
        if (MULTI_PART_TLDS.has(domain.toLowerCase()) && parts.length > 2) {
