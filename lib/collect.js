...
module.exports = {
   ...
   * @private
   */
  collectDomainInfo: function(asset, domains) {
   ...
   * @private
   */
  collectResponseCode: function(asset, responseCodes) {
   ...
   * @private
   */
  collectContentType: function(asset, myPage) {
    if (asset.status === 200) {
