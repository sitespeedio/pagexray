...
module.exports = {
  ...
  convert: function(har, config) {
    ...
    har.log.entries.forEach(function(entry) {
      ...
      let asset = collect.collectAsset(entry);
      assets.push(asset);
      collect.collectDomainInfo(asset, domains);
      collect.collectResponseCode(asset, responseCodes);
      collect.collectContentType(asset, myPage);
